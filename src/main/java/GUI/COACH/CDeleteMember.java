...
public class CDeleteMember extends JFrame implements ActionListener {
    ...
    public CDeleteMember(String id) {
        coachID = id;
        ...
        selectCoachLabel = new JLabel("Select MEMBER");
        ...
        backButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Logger.getLogger(CDeleteMember.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == deleteButton) {
            ...
            if (DbTools.deleteUser(delID) == 1) {
                JOptionPane.showMessageDialog(scheduleTable, "Deleted Unsuccessfully");
            } else {
                JOptionPane.showMessageDialog(scheduleTable, "Delete Successful");
            }
            renderTable();
        }
